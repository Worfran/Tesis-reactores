...
\usepackage{braket}
\usepackage[backend=bibtex,style=ieee,citestyle=numeric-comp,natbib=true]{biblatex}
\usepackage{mathtools}
\usepackage{multirow}
\usepackage{booktabs}

%errores en el compilado de la bibliografia
%\usepackage{natbib}
...
%Para tablas,  redefine el backschlash en tablas donde se define la posicion del texto en las
...
%Neuer Befehl fur die Tabelle Eigenschaften der Aktivkohlen
