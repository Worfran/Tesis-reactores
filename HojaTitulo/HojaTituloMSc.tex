...
\begin{figure*}
    \centering%
    \includegraphics[scale=0.45]{HojaTitulo/Figures_HojaTitulo/Universidad_de_los_Andes_(logo).png} % Replace \epsfig with \includegraphics and remove the ".eps" extension
\end{figure*}
