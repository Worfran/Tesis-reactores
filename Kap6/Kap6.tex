...
\subsubsection{Liquid Fuel Reactors Mathematical Models}
...
\begin{flalign}
    && D \nabla^{2} \phi(z) + \left[ \nu \Sigma_{f} (1-\beta) - \Sigma_{a}(Z) \right] \phi_{0}(z) + \lambda C_{0}(z) = 0 &&
    \label{eq:neutron_flux_lf}
\end{flalign}

\begin{flalign}
    && u \frac{dC_{0}(z)}{dz} = \beta\nu\Sigma_{f}\phi_{0}(z) - \lambda C_{0}(z) &&
...
\begin{flalign}
    && C_{0}(z) = e^{- \lambda \tau_{L}/u} \left( \frac{1}{e^{\lambda \tau} - 1} \int_{0}^{H} e^{- \lambda z'/u} \phi_{0}(z') dz' + \int_{0}^{H} e^{- \lambda z'/u} \phi_{0}(z') dz' \right) &&
\end{flalign}
...
\begin{flalign}
    D \nabla^{2} \phi_{0}(z) + \left[ \nu \Sigma_{f} (1-\beta) - \Sigma_{a} \right] \phi_{0}(z) && \nonumber \\  
    + e^{-\lambda z/u} \frac{\lambda \beta \nu \Sigma_{f}}{u} \left(  \frac{1}{e^{\lambda \tau} - 1} \int_{0}^{H} e^{- \lambda z'/u} \phi_{0}(z') dz' + \frac{\beta \nu \Sigma_{f}}{u} \int_{0}^{z} e^{- \lambda z'/u} \phi_{0}(z') dz' \right) = 0 &&
\end{flalign}
